...
# Make sure the uploads folder exists (a fresh container/deploy won't have it)
...
if __name__ == '__main__':
    # debug is off and the app binds to the PORT env var Render/Railway/Heroku inject
